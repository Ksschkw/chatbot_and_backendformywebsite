...
import torch
from chat import get_fallback_response, initialize_model, process_message
import os
...
app = Flask(__name__)
CORS(app, resources={r"/chat": {"origins": "https://kosisochukwu.onrender.com"}})  # <-- Enable CORS for all routes
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=port)  # Add debug=True here